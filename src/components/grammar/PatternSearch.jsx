...
export default function PatternSearch({ patterns }) {
    ...
    <>
      <style>{`
        ...
        @media (max-width: 900px) {
          .pattern-card-grid { grid-template-columns: repeat(2, 1fr); }
        }
        @media (max-width: 560px) {
          .pattern-card-grid { grid-template-columns: 1fr; }
        }
        .pattern-search-input::placeholder { color: #9baab8; }
        .pattern-search-input:focus { outline: none; border-color: #2E6FA3 !important; box-shadow: 0 0 0 3px rgba(46,111,163,0.12); }
      `}</style>
          ...
          {trimmed && (
            <button
              ...
              style={{
                ...
                padding: '0 4px', lineHeight: 1, fontSize: '16px',
              }}
            >
              ✕
            </button>
