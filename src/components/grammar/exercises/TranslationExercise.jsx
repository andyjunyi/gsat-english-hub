...
export default function TranslationExercise({ exercises, patternTitle }) {
      ...
      {isSubmitted && gradeResult && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '16px' }}>
            <span style={{ fontSize: '40px', fontWeight: 800, color: scoreColor(gradeResult.score), lineHeight: 1 }}>
              {gradeResult.score}
            </span>
